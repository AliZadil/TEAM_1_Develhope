...
//IFO SECTION ENDS
    return(
        <>
              ...
              <span className="h2">
                ...
                <span className="stam">Stake, Earn - And More!</span>
                                ...
                                <div className="ifoImage1">
                                    <img
                                        className="beer"
                                        src="../public/images/Ifo-images/beer1.svg"
                                    />
                                    <img
                                        className="arrReverse"
                                        src="../public/images/Ifo-images/autorenew.svg"
                                    />
                                </div>
                            </div>
                            <div className="k2">
            ...
            <span id="auto/locked" className="pottery">
              Auto/Locked
                                ...
                                <button id="topDetailsBtn" className="btnDetails">
                                    ...
                                    <img
                                        className="darrow"
                                        src="../public/images/Ifo-images/darrow.svg"
                                    />
                                </button>
                            </div>
                        </div>
                  ...
                  You have no tokens available for claiming
                                ...
                                <div className="ifoImage1">
                                    <img
                                        id="beer"
                                        className="beer"
                                        src="../public/images/Ifo-images/not-tokens.svg"
                                    />
                                </div>
                            </div>
            ...
            <img
                className="ques?"
                src="../public/images/Ifo-images/sdf.svg"
            />
                    ...
                    <div id="sCk3" className="sCk3">
                        <div className="cmsDiv">
                            <img
                                ...
                                src="../public/images/Ifo-images/ifo-coming-soon-desktop.png"
                            />
                        </div>
                        <div className="sect1">
                            <div className="rect1">
            <span className="fle1">
              Public Sale{" "}
                <img src="../public/images/Ifo-images/quest.svg" />
            </span>
                                <div className="k1sec22">
                                    <img
                                        className="ques?"
                                        src="../public/images/Ifo-images/sew.svg"
                                    />
                                    <span className="ad">
            ...
            bought, and any unspent CAKE tokens will be returned to your wallet.
                ...
                <div id="LastSec" className="LastSec">
                    <div className="jnLastSec">
                        <img
                            className="bunny"
                            src="../public/images/Ifo-images/ifo-bunny.png"
                        />
        ...
        Apply to run an IFO
        <img src="../public/images/Ifo-images/REF.svg" />
      </span>
                </div>
            </div>
